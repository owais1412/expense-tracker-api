...
public class CategoryRepositoryImpl implements CategoryRepository{
    ...
    private static final String SQL_UPDATE = "UPDATE ET_CATEGORIES SET TITLE=?,DESCRIPTION=? WHERE CATEGORY_ID=? AND USER_ID=?";
    ...
    public void update(Integer userId, Integer categoryId, Category category) throws EtBadRequestException {
        try {
            jdbcTemplate.update(SQL_UPDATE, new Object[]{category.getTitle(),category.getDescription(),categoryId,userId});
        } catch (Exception e) {
            throw new EtBadRequestException("Invalid request");
        }
    }
